package com.raillylinker.springboot_mvc_template_private.data_sources.const_objects
...
object ProjectConst {
    ...
    // (DatabaseConfig)
    // !!!본인의 패키지명 작성!!!
    const val PACKAGE_NAME = "com.raillylinker.springboot_mvc_template_private"
}