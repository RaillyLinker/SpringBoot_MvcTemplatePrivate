...
class C2Service1TkV1RequestTestController(
    ...
    fun api23LoggedInAccessTest(
        ...
        return service.api23LoggedInAccessTest(httpServletResponse, authorization!!)
    }


    ////
    @Operation(
        summary = "N24 : ADMIN 권한 진입 테스트 <'ADMIN'>",
    ...
    fun api24AdminAccessTest(
        ...
        return service.api24AdminAccessTest(httpServletResponse, authorization!!)
    }


    ////
    @Operation(
        summary = "N25 : Developer 권한 진입 테스트 <'ADMIN' or 'Developer'>",
    ...
    fun api25DeveloperAccessTest(
        ...
        return service.api25DeveloperAccessTest(httpServletResponse, authorization!!)
    }
}